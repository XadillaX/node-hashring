...
HashRing.prototype.get = function (key) {
...
HashRing.prototype.find = function(key) {
    return this.getNodePosition(key);
};
...
HashRing.prototype.swap = function(oldServer, newServer) {
    return this.replaceServer(oldServer, newServer);
};
...
HashRing.prototype.add = function(server, weights) {
    return this.addServer(server, weights);
};
...
HashRing.prototype.remove = function(server) {
